...
class ListProjectsTwo extends StatefulWidget {
  ListProjectsTwo();
  @override
  _ListProjectsState createState() => _ListProjectsState();
}

class _ListProjectsState extends State<ListProjectsTwo> {
  Alert alert;
  ...
  Future getProjects() async {
    ...
    projectsData = await listProjectsController.getListProjectsProcess(context);
    print(projectsData);
    print('hola');
    bool state = false;
    ...
    final card = Container(
      child: Column(
        ...
        children: <Widget>[
          ...
          Column(  
            children: <Widget> [
              _createCarousel(project["imagesProject"]),
            ]
          ),
          ListTile(
